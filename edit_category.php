       ...
       <div class="container"><!-- container Begin -->
           ...
           <div class="col-md-12"><!-- col-md-12 Begin -->
            ...
            <?php
                ...
                $sql = "SELECT * FROM category WHERE category_id = $idd";
                ...
                echo "<form method='post'><!-- form Begin -->
                                        ...
                                        <div class='form-group'><!-- form-group Begin -->
                                            ...
                                            <input type='text' class='form-control' name='category_description' value='".$row["category_description"]."' required>
                ...
                if (isset($_POST["update"])) {
                                ...
                                $sql = "UPDATE category SET category_name='$name', category_description='$des' WHERE category_id='$idd'";
                                if (mysqli_query($conn, $sql)) {
                                    echo '<div class="alert">
                                    <h2>Reminder</h2>
                                    <p>Category information updated successfully!</p>
                                    <a href="category.php">
                                    <button>Close</button>
                                    </a>
                                    </div>';
                                } else {
                                    echo "Error updating category information: " . mysqli_error($conn);
                                }
