...
echo "<form method='post'><!-- form Begin -->
                           ...
                           <div class='form-group'><!-- form-group Begin -->
                               ...
                               <input class='form-control' name='customer_password' required>
                            ...
                            <div class='form-group'><!-- form-group Begin -->
                                ...
                                <input class='form-control' name='customer_paymethod' required>
...
if (isset($_POST["add"])) {
				...
				if (mysqli_query($conn, $sql)) {
                    ...
                    <h2>Reminder</h2>
                    <p>Customer Information Inserted Successfully!</p>
                    <a href="customer.php">
                    <button>Close</button>
                    </a>
                    </div>';
