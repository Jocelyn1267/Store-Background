                    ...
                    <div class="box-header"><!-- box-header Begin -->
                       ...
                       <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="datetime-local" class='form-control' name="time"><br>
                        </div>
                        ...
                        <div class="form-group">
                            <label for="order_paymethod">Order Payment:</label>
                            &nbsp;
                            <select class="styled-select" name="paymethod">
                        ...
                        if (isset($_POST['add_order'])) {
                            ...
                            $sql = "INSERT INTO orders (customer_id, order_time, order_price, order_address, order_status, order_paymethod) 
                                    VALUES ('$customer_id', '$order_time', '$order_price', '$order_address', '$order_status', '$order_paymethod')";
                            
                            if (mysqli_query($conn, $sql)) {
                                echo '<div class="alert">
                                        <h2>Reminder</h2>
                                        <p>New Order Inserted Successfully!</p>
                                        <a href="order.php">
                                        <button>Close</button>
                                        </a>
                                      </div>';
